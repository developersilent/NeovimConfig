...
-- Auto close brackets (specific to 'man' filetype)
api.nvim_create_autocmd("FileType", {
  pattern = "man",
...
api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(event)
      ...
      wk.add {
        ...
        { "<leader>lf", vim.lsp.buf.format, desc = "Format" },
        {
          ...
          function()
            ...
            if utils_ok and utils.copyFilePathAndLineNumber then
              utils.copyFilePathAndLineNumber()
            else
              print "config.utils not available"
            end
          end,
    ...
    -- Document highlight without custom function
